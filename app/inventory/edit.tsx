...
import { getInventoryItem, updateInventoryItem } from '../../src/db/inventoryRepository';
import {
  saveInventoryPhoto,
  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        setPurchaseCost(data.purchase_cost != null ? String(data.purchase_cost) : '');
      ...
      if (photoUri !== originalPhotoUri) {
        if (photoUri) {
          if (originalPhotoUri) {
            ...
            finalPhotoUri = await saveInventoryPhoto(photoUri, item.inventory_number);
          }
  ...
  return (
    ...
    >
      ...
      >
        ...
        <TextInput style={inputStyle} value={name} onChangeText={setName} placeholderTextColor="#9CA3AF" />
        <Text style={labelStyle}>Description</Text>
        <TextInput style={[inputStyle, styles.multiline]} value={description} onChangeText={setDescription} multiline numberOfLines={3} placeholderTextColor="#9CA3AF" />
        <Text style={labelStyle}>Category</Text>
        <TextInput style={inputStyle} value={category} onChangeText={setCategory} placeholderTextColor="#9CA3AF" />
        <Text style={labelStyle}>Bin Location</Text>
        <TextInput style={inputStyle} value={binLocation} onChangeText={setBinLocation} placeholderTextColor="#9CA3AF" />
        <Text style={labelStyle}>Purchase Cost</Text>
        <TextInput style={inputStyle} value={purchaseCost} onChangeText={setPurchaseCost} keyboardType="decimal-pad" placeholderTextColor="#9CA3AF" />
        <Text style={labelStyle}>Listing Price</Text>
        <TextInput style={inputStyle} value={listingPrice} onChangeText={setListingPrice} keyboardType="decimal-pad" placeholderTextColor="#9CA3AF" />
        <Text style={labelStyle}>Sale Price</Text>
        <TextInput style={inputStyle} value={salePrice} onChangeText={setSalePrice} keyboardType="decimal-pad" placeholderTextColor="#9CA3AF" />
...
const styles = StyleSheet.create({
  ...
  btn: { paddingHorizontal: 20, paddingVertical: 12, borderRadius: 10, minWidth: 100, alignItems: 'center' },
  cancelBtn: {},
